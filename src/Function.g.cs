...
namespace ExitStairs
{
    public class Function
    {
        ...
        private IModelStore<ExitStairsInputs> store;

        public async Task<ExitStairsOutputs> Handler(ExitStairsInputs args, ILambdaContext context)
        {
            ...
            if(this.store == null)
            {
                this.store = new S3ModelStore<ExitStairsInputs>(RegionEndpoint.USWest1);
            }

            var l = new InvocationWrapper<ExitStairsInputs,ExitStairsOutputs>(store, ExitStairs.Execute);
