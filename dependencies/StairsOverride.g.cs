...
namespace ExitStairs
{
	...
	public static class StairsOverrideExtensions
    {
		/// <summary>
        /// Apply Stairs edit overrides to a collection of existing elements
        /// </summary>
        /// <param name="overrideData">The Stairs Overrides to apply</param>
        ...
        public static List<T> Apply<T>(
            this IList<StairsOverride> overrideData,
            IEnumerable<T> existingElements,
            Func<T, StairsIdentity, bool> identityMatch,
            Func<T, StairsOverride, T> modifyElement) where T : Element
        {
        ...
        /// </summary>
        /// <param name="existingElements">A collection of existing elements to which to apply the overrides.</param>
        /// <param name="overrideData">The Stairs Overrides to apply — typically `input.Overrides.Stairs`</param>
        /// <param name="identityMatch">A function returning a boolean which indicates whether an element is a match for an override's identity.</param>
        /// <param name="modifyElement">A function to modify a matched element, returning the modified element.</param>
        /// <typeparam name="T">The element type this override applies to. Should match the type(s) in the override's context.</typeparam>
        /// <returns>A collection of elements, including unmodified and modified elements from the supplied collection.</returns>
        public static void ApplyOverrides<T>(
            ...
            IList<StairsOverride> overrideData,
            Func<T, StairsIdentity, bool> identityMatch,
            Func<T, StairsOverride, T> modifyElement
            ) where T : Element
        {
        ...
        /// </summary>
        /// <param name="edits">The collection of edit overrides (Overrides.Stairs)</param>
        /// <param name="additions">The collection of add overrides (Overrides.Additions.Stairs)</param>
        /// <param name="removals">The collection of remove overrides (Overrides.Removals.Stairs)</param>        /// <param name="identityMatch">A function returning a boolean which indicates whether an element is a match for an override's identity.</param>
        ...
        public static List<T> CreateElements<T>(
            this IList<StairsOverride> edits,
            IList<StairsOverrideAddition> additions,
            IList<StairsOverrideRemoval> removals,            Func<StairsOverrideAddition, T> createElement,
            Func<T, StairsIdentity, bool> identityMatch,
            Func<T, StairsOverride, T> modifyElement,
